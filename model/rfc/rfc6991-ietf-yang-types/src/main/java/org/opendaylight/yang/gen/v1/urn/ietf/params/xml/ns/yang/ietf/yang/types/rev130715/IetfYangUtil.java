...
public final class IetfYangUtil {
    private static final @NonNull UnsafeScalarTypeObjectFactory<PhysAddress, String> PHYS_FACTORY;
    private static final @NonNull UnsafeScalarTypeObjectFactory<DottedQuad, String> QUAD_FACTORY;
    private static final @NonNull UnsafeScalarTypeObjectFactory<MacAddress, String> MAC_FACTORY;
    private static final @NonNull UnsafeScalarTypeObjectFactory<HexString, String> HEX_FACTORY;
    private static final @NonNull UnsafeScalarTypeObjectFactory<Uuid, String> UUID_FACTORY;
