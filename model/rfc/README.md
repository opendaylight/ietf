...
marked as _NOT_ being maintained by IANA. These typically start with `ietf-`.
...
- a single YANG module _MAY_ be packaged in multiple artifacts for compatibility, but generally we strive for not
