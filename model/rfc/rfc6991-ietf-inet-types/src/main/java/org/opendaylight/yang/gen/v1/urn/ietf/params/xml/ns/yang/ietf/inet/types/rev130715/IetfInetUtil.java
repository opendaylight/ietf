...
public final class IetfInetUtil {
    ...
    private static final @NonNull UnsafeScalarTypeObjectFactory<Ipv4AddressNoZone, String> V4NZ_FACTORY;
    private static final @NonNull UnsafeScalarTypeObjectFactory<Ipv4Prefix, String> P4_FACTORY;

    private static final @NonNull Ipv6Prefix V6_SLASH_ZERO = new Ipv6Prefix( "::0/0");
    private static final @NonNull UnsafeScalarTypeObjectFactory<Ipv6AddressNoZone, String> V6NZ_FACTORY;
    private static final @NonNull UnsafeScalarTypeObjectFactory<Ipv6Prefix, String> P6_FACTORY;
    ...
    private static <T extends ScalarTypeObject<String>> @NonNull T prefixToAddress(
            final UnsafeScalarTypeObjectFactory<T, String> factory, final String str) {
